...
const camera=new THREE.PerspectiveCamera(
    75,
    (window.innerWidth *0.6 )/ window.innerHeight,//窗口文档显示区的宽度作为画布宽度，窗口文档显示区的高度作为画布高度
    0.1,
    1000
);
...
window.onresize=function(){
    renderer.setSize(window.innerWidth*0.6,window.innerHeight);//更新画布尺寸
    camera.aspect=(window.innerWidth*0.6 )/ window.innerHeight;//重新写入宽高比
